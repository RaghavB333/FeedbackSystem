    ...
    <div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-around mb-8">
          <div className="bg-white shadow-lg rounded-lg p-6 mb-4 md:mb-0 w-full md:w-1/3 transition-transform transform hover:scale-105">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 mb-4 md:mb-0 w-full md:w-1/3 transition-transform transform hover:scale-105">
            <h3 className="text-lg font-bold mb-2">2. Give Feedback</h3>
            <p className="text-gray-600 mb-4">Share your thoughts on courses and instructors.</p>
            <a href="/feedback" className="block text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              Give Feedback
            </a>
          </div>
          <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-1/3 transition-transform transform hover:scale-105">
