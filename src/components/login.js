            ...
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            {showPassword ? (
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 509.319 509.319" width="25" height="25" fill='gray'>
                                    <g>
